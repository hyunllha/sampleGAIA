...
class TwoStepProcess:
    ...
    def translate_inquiry(self, inquiry_title, inquiry_content):
        ...
        try:
            ...
            # 2. 사용자 입력 구성
            user_input = self._create_translation_input(inquiry_title, inquiry_content)
            ...
            try:
                ...
                # 템플릿 추천 정보 추가
                result["recommended_templates"] = self._recommend_templates(result["summary"])
                return result
    ...
    def generate_response(self, inquiry_title, inquiry_content, translated_summary, 
        ...
        try:
            ...
            # 4. 사용자 입력 구성
            user_input = self._create_response_input(
                inquiry_title, 
                inquiry_content,
                translated_summary,
                project_info,
    ...
    def _create_response_input(self, inquiry_title, inquiry_content, translated_summary, 
                              project_info, template=None, custom_response=None):
        """
    ...
    def _recommend_templates(self, summary):
            ...
            for word in word_list:
                if word in summary:
                    ...
                    category_templates = templates_df[
                        templates_df[RESPONSE_TEMPLATE_COLUMNS["TEMP_CATEGORY"]] == category
                    ]
        ...
        # 기본 템플릿 항상 추가
        basic_templates = templates_df[
            templates_df[RESPONSE_TEMPLATE_COLUMNS["TEMP_CATEGORY"]] == "기본"
        ]
